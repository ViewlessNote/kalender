...
var require_src = __commonJS({
  "node_modules/vue-date-fns/src/index.js"(exports, module) {
    var formatDate = (init_esm(), __toCommonJS(esm_exports)).format;
    var DEFAULT_DATE_FORMAT = "yyyy-MM-dd'T'HH:mm:ss.SSSxxx";
    function createDateFilter(defaultFormat2, defaultOptions2) {
      return function dateFilter(date, format2, opts) {
        if (!date) {
          return "";
        }
        return formatDate(date, format2 || defaultFormat2 || DEFAULT_DATE_FORMAT, Object.assign({}, defaultOptions2 || {}, opts));
      };
    }
    function install(Vue, defaultFormat2, defaultOptions2, globalFilterName) {
      var dateFilter = createDateFilter(defaultFormat2, defaultOptions2);
...
//# sourceMappingURL=vue-date-fns.js.map
